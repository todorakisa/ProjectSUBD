...
public static b4a.example.types _types = null;
  public Object[] GetGlobals() {
		return new Object[] {"HelperFunctions",Debug.moduleToString(b4a.example.helperfunctions.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"types",Debug.moduleToString(b4a.example.types.class)};
}
}