...
try {
		Debug.PushSubsStack("Apply_ViewStyle (helperfunctions) ","helperfunctions",6,_ba,helperfunctions.mostCurrent,5);
...
try {
		Debug.PushSubsStack("Helper_Gradient (helperfunctions) ","helperfunctions",6,_ba,helperfunctions.mostCurrent,22);
...
helperfunctions._shareprice = RemoteObject.createImmutable("");
 //BA.debugLineNum = 3;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _remove_padding(RemoteObject _ba,RemoteObject _obj) throws Exception{
try {
		Debug.PushSubsStack("Remove_Padding (helperfunctions) ","helperfunctions",6,_ba,helperfunctions.mostCurrent,56);
