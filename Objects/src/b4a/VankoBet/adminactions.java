...
int _t = 0;
 ...
 //BA.debugLineNum = 169;BA.debugLine="DB.database.Initialize(File.DirDefaultExternal,\"A";
...
_cursor1 = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 86;BA.debugLine="DB.database.Initialize(File.DirDefaultExternal,\"A";
_db._database.Initialize(__c.File.getDirDefaultExternal(),"AppDB.db",__c.True);
